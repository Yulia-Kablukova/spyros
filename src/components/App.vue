...
const templates = ref([
  ...
  },
  {
    type: 21,
    regexp:
      /^([0-9]+х)?[0-9]+ к?м\([0-9]+ раз-прыжки в выпадах на месте со сменой ног в воздухе\+[0-9]+ м-многоскоки в гору\+[0-9]+ м-с\.у\. в гору силовым бегом\+[0-9]+ раз-выпрыгивания вверх с (полных приседов)?(полуприседов)? на месте\+[0-9]+ м-очень спокойная трусца под гору\+[0-9]+ раз-прыжки в выпадах на месте со сменой ног в воздухе\+[0-9]+ м-многоскоки в гору\+[0-9]+ м-с\.у\. в гору\+[0-9]+ раз-выпрыгивания вверх с (полных приседов)?(полуприседов)? на месте\+[0-9]+ м-очень спокойная трусца под гору\+[0-9]+ раз-прыжки в выпадах на месте со сменой ног в воздухе\+[0-9]+ м-прыжки на одной ноге в гору\([0-9]+ м-на левой,[0-9]+ м-на правой\)\+[0-9]+ м-многоскоки в гору\+[0-9]+ м-с\.у\. в гору\)(\(через [0-9]+ м\(до 22\)\))?/,
    resultsPerSeries: 1,
  },
  {
    type: 22,
